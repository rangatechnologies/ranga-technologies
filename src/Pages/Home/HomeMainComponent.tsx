...
export default function HomeMainComponent() {
  ...
  const mainTitle = (
    <div className="text-secondary text-4xl md:text-5xl font-black">
      ...
      <span style={{ color: "#F2E34C" }}>Blockchain</span>
      <br />
  ...
  return (
    <div>
              ...
              >
                ...
                >
                  ...
                  <div style={{ paddingBottom: 20, paddingTop: 10 }}>
                    ...
                    <button
                      onClick={() => window.open("https://t.me/rangaubot")}
                    ...
                    <button
                      onClick={() =>
                        window.open(
                          "https://instagram.com/rangatechnologies?igshid=NGExMmI2YTkyZg=="
                        )
                      }
                      className="button button4"
                    >
          ...
          <button className="hover:bg-[#B1B2FF]  hover:scale-110  duration-500 drop-shadow-lg bg-blue-200 rounded-lg  p-4 bg-[#FAF3F0]   ">
            <div className="inline-block">
              ...
              <div className="  ">
                ...
                <h2 className="text-1xl text-center mb-3 mt-3 ">
      ...
      <div className="w-full  h-60 md:h-75 lg:h-48 bg-[#ECF2FF]">
        ...
        <h2 className=" text-2xl md:text-4xl lg:text-6xl text-center font-neu mb-2">
