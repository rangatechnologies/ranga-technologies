...
import Wrapper from "../Component/BgVideo/BgVideo";
...
function App() {
  return (
    ...
    <div
      className="h-screen overflow-x-hidden scroll-smooth overflow-y-visible "
      id="page-container"
    >
      ...
      type="button"
      className="hover:h-10 hover:w-10 hover:duration-300 hover:bg-green-500 hover:border-green-500 hover:shadow-lg m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out focus:outline-none focus:ring-0"
      data-te-ripple-init
      ...
      >
        <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
              ...
              <a
                href="#!"
                type="button"
                className="hover:h-10 hover:w-10 hover:duration-300 hover:fill-[#128c7e] m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                data-te-ripple-init
                data-te-ripple-color="light"
              >
                <svg
              ...
              <a
                ...
                type="button"
                className=" hover:h-10 hover:w-10 hover:duration-300 hover:fill-[#128c7e] transform m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                data-te-ripple-init
                data-te-ripple-color="light"
              >
                <svg
